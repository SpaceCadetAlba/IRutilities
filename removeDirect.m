...
% ch: The channel index used for direct sound and first reflection time
% estimations
%
...
function removeDirect(sHeight, rHeight, srDist, horDisp, fadeSize, ch)
% Load Audio---------------------------------------------------------------
...
% Pre-processing-----------------------------------------------------------
% Audio
omniCh = audio(:, ch); % Get omnidirectional channel
